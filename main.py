...
src_path = ""
# 发件人邮箱
sender = 'zhangzhenfeng@anyuntec.com'
# 发件人邮箱密码，该密码为动态密码
sender_pass = 'Ev2hZBTQxqwZkfFB'
# 收件人邮箱
receivers_1 = {'hanpeng@anyuntec.com':"韩鹏",'xudong@anyuntec.com':"许东",'niyueheng@anyuntec.com':"倪悦恒",'fanxiaoran@anyuntec.com':"范晓然",'liyang@anyuntec.com':"李阳",'990768144@qq.com':"张振峰"}
nameToPin = {"许东":"xudong", "倪悦恒":"niyueheng", "范晓然":"fanxiaoran", "韩鹏":"hanpeng", "李阳":"liyang", "张振峰":"zhangzhenfeng"}
receivers_2 = {"韩鹏":'hanpeng@anyuntec.com',"许东":'xudong@anyuntec.com',"倪悦恒":'niyueheng@anyuntec.com',"范晓然":'fanxiaoran@anyuntec.com',"李阳":'liyang@anyuntec.com',"张振峰":'990768144@qq.com'}
#receivers_2 = {"韩鹏":'990768144@qq.com',"许东":'990768144@qq.com',"倪悦恒":'990768144@qq.com',"范晓然":'990768144@qq.com',"李阳":'990768144@qq.com',"张振峰":'990768144@qq.com'}
# 腾讯服务器地址
...
def sendMail(target,msg):
    ...
    try:
        ...
        Logger().logger.error("[-]无法发送邮件，涉及收件人%s,邮件内容【%s】" % (str(target),msg))
def outName(path):
    f = path.index("日报-") + 7
    t = path.index(".xlsx")
    return path[f:t]
